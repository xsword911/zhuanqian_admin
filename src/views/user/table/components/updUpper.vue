  ...
  >
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="邀请码" prop="code">
        <el-input v-model.trim="form.code" autocomplete="off" clearable :disabled="true"></el-input>
      </el-form-item>
...
<!--      <el-form-item label="头像">
      ...
      <el-form-item label="上级uid" prop="upper">
...
export default {
  ...
  methods: {
    ...
    save() {
        if(util.isEmpty(this.form.upper)){
          this.$message.error('直属上级uid不能为空');
        	return;
        }
        this.submitUpd();
    },
