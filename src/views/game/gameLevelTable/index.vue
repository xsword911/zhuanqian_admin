...
<!--       <el-button icon="el-icon-plus" type="primary" @click="handleAdd"
       style="position: absolute; left: 0; top:34%;display:block; transform: translateY(-50%);"
        ...
        <el-form-item>
            <el-input v-model="queryForm.level" placeholder="游戏关卡"  clearable/>
        </el-form-item>
...
<!--      <el-table-column label="序号" width="95">
      ...
      <el-table-column prop="level" label="游戏关卡" sortable></el-table-column>
      <el-table-column prop="progress" label="进度" sortable></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      if(util.isEmpty(this.selectRows)){
        ...
        this.$baseConfirm("你确定要删除选中项吗", null, async () => {
            ...
            api.delGameLevelArr(delArr, (res)=>{
    ...
    async fetchData() {
      ...
      api.getGameLevel(this.queryForm, (res)=>{
         let code = api.getCode(res);
         if(code == 0){
