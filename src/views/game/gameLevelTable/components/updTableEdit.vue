<template>
  ...
  <el-form ref="form" :model="form" label-width="80px" :rules="rules">
    ...
    <el-form-item label="进度" prop="progress">
      <el-input v-model.trim="form.progress" autocomplete="off"></el-input>
    </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        level: [{ required: true, trigger: "blur", message: "请输入游戏关卡" }],
        progress: [{ required: true, trigger: "blur", message: "请输入进度" }],
      }
    };
  },
  created() {},
  methods: {
    ...
    save() {
      this.$refs["form"].validate(async (valid) => {
        if (valid) {
          api.updGameLevel(this.form, (res)=>{
