...
<!--     <el-table-column label="序号" width="95">
      ...
      <el-table-column prop="randomMin" label="随机金额最小值" sortable></el-table-column>
      <el-table-column prop="randomMax" label="随机金额最大值" sortable></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      api.getLuckRed(this.queryForm, (res)=>{
         let code = api.getCode(res);
         if(code == 0){
